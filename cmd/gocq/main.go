...
import (
	...
	"github.com/Sclock/MiraiGo/wrapper"
	...
	"github.com/Sclock/go-cqhttp/internal/selfdiagnosis"
	"github.com/Sclock/go-cqhttp/internal/selfupdate"
	"github.com/Sclock/go-cqhttp/modules/servers"
	"github.com/Sclock/go-cqhttp/server"
)
...
func LoginInteract() {
	...
	log.Info("开始加载好友列表...")
	global.CheckWarn(cli.ReloadFriendList(), true)
	log.Infof("共加载 %v 个好友.", len(cli.FriendList))
	log.Infof("开始加载群列表...")
	global.CheckWarn(cli.ReloadGroupList(), true)
